                ...
                <?php foreach ($budgetsWithDisplay as $budgetData): ?>
                    ...
                    <div class="card" data-id="<?= $budget->id ?>">
                        <div>
                            ...
                            <p>Сумма: <?= Html::encode($budgetData['display_amount']) ?> <?= Html::encode($userCurrency) ?></p>
                            <p>Потрачено: <?= Html::encode($budgetData['display_spent']) ?> <?= Html::encode($userCurrency) ?></p>
                            ...
                            <p>Остаток: <?= Html::encode($budgetData['display_remaining']) ?> <?= Html::encode($userCurrency) ?></p>
